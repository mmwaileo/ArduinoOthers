#ifndef SIMPLE_MODBUS_SLAVE_MKR_H
#define SIMPLE_MODBUS_SLAVE_MKR_H
...
void modbus_configure(long baud, byte _slaveID, bool _HalfDuplexEnable, unsigned int _holdingRegsSize, unsigned char _lowLatency);
