...
void main_test(void)
{
	...
	Gui_StrCenter(0,90,GREEN,BLUE,"4.0\" ILI9486 320X480",16,1);//居中显示
	Gui_StrCenter(0,120,BLUE,BLUE,"xiaoFeng@QDtech 2021-06-06",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
